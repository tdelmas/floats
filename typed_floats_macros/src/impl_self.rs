...
pub fn get_impl_self() -> Vec<Op> {
    vec![
        OpBuilder::new("neg")
            ...
            .result(Box::new(fn_num_types::core::ops::neg))
            .build(),
        ...
        OpBuilder::new("abs")
            ...
            .result(Box::new(fn_num_types::core::ops::abs))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("ceil")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::ceil))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("floor")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::floor))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("round")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::round))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("trunc")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::trunc))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("fract")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::fract))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("signum")
            ...
            .result(Box::new(fn_num_types::core::ops::signum))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("sqrt")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::sqrt))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("exp")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::exp))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("exp2")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::exp2))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("ln")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::ln))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("log2")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::log2))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("log10")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::log10))
            .build(),
        OpBuilder::new("to_degrees")
            ...
            .result(Box::new(fn_num_types::core::ops::to_degrees))
            .build(),
        OpBuilder::new("to_radians")
            ...
            .result(Box::new(fn_num_types::core::ops::to_radians))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("cbrt")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::cbrt))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("sin")
            ...
            .result(Box::new(fn_num_types::core::ops::sin))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("cos")
            ...
            .result(Box::new(fn_num_types::core::ops::cos))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("tan")
            ...
            .result(Box::new(fn_num_types::core::ops::tan))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("asin")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::asin))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("acos")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::acos))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("atan")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::atan))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("exp_m1")
            ...
            .result(Box::new(fn_num_types::core::ops::exp_m1))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("ln_1p")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::ln_1p))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("sinh")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::sinh))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("cosh")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::cosh))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("tanh")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::tanh))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("asinh")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::asinh))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("acosh")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::acosh))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("atanh")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::atanh))
            .build(),
        OpBuilder::new("recip")
            .description(quote! {
            ...
            .result(Box::new(fn_num_types::core::ops::recip))
            .build(),
        #[cfg(any(feature = "std", feature = "libm"))]
        OpBuilder::new("powi")
            ...
            .result(Box::new(fn_num_types::core::ops::powi))
            .skip_check_return_type_strictness()
            .op_test(Box::new(|var| {
                quote! { #var.powi(2) }
            }))
